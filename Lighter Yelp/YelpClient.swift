...
//    }
    ...
    func searchWithTerm(offset: Int?, _ term: String, sort: YelpSortMode?, distance: Int?, categories: [String]?, deals: Bool?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
